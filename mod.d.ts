 ...
 */
export interface DecodedStatTag extends DecodedBaseTag {
  hash?: null;
  size: number;
  mtime: Timestamp<false>;
}

export interface DecodedEntityTag extends DecodedStatTag {
  hash: string;
  mtime?: null;
}
 ...
 */
export interface FileInfo<Parsed = false> {
  /**
...
export interface ExtendedFileInfo<Parsed = false> extends FileInfo<Parsed> {
  /**
